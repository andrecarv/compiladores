...
{
  "$end", "error", "$undefined", "T_VINTEIRO", "T_VREAL", "T_VBOOLEANO",
  "T_ADICAO", "T_SUBTRACAO", "T_MULTIPLICACAO", "T_DIVISAO",
  "T_ATRIBUICAO", "T_IGUAL", "T_DIFERENTE", "T_MAIOR", "T_MENOR",
  "T_MAIORIGUAL", "T_MENORIGUAL", "T_ERELACIONAL", "T_OURELACIONAL",
  "T_NEGACAO", "T_FIMLINHA", "T_INTEIRO", "T_REAL", "T_BOOLEANO", "T_ID",
  "T_VIRGULA", "$accept", "program", "lines", "line", "expr", "varlist", YY_NULLPTR
};
#endif
...
{
      77,   -23,   -23,   -23,   -23,   -22,   -22,   -22,     2,    25,
      77,   -23,   101,   -23,    63,    64,    99,    23,   -23,   -23,
...
{
       0,    11,    12,    13,     5,     0,     0,     0,    14,     0,
       2,     3,     0,    20,     0,     0,     0,     0,     1,     4,
      19,     0,     0,     0,     0,     6,     7,     0,     8,     9,
      14,     0,     0,     0,     0,     0,    21
};
...
{
     -10,    20,    13,   -10,   -10,   -10,    21,    22,    23,    24,
     -15,    20,    17,   -15,   -15,   -15,   -15,   -15,    23,    24,
     -10,   -10,   -10,   -10,   -10,    18,     1,     2,     3,    36,
     -15,   -15,   -15,   -15,   -15,   -16,    20,    19,   -16,   -16,
     -16,   -16,   -16,    23,    24,   -17,    20,    30,   -17,   -17,
     -17,   -17,   -17,   -17,   -17,   -16,   -16,   -16,   -16,   -16,
      15,    16,     0,     0,     0,   -17,   -17,   -17,   -17,   -17,
     -18,    20,     0,   -18,   -18,   -18,   -18,   -18,   -18,   -18,
       1,     2,     3,    26,    28,     0,     0,     0,    27,    27,
     -18,   -18,   -18,   -18,   -18,     0,     0,     4,     5,     6,
       7,     8,    20,     0,     0,     0,     0,    21,    22,    23,
      24,    31,     0,     0,     0,    32,    33,    34,    35,    29,
       0,    25,     0,     0,    27
};
...
static const yytype_int8 yycheck[] =
{
      ...
      20,    21,    22,    23,    24,     0,     3,     4,     5,    24,
      20,    21,    22,    23,    24,     0,     1,    10,     3,     4,
       5,     6,     7,     8,     9,     0,     1,    24,     3,     4,
       5,     6,     7,     8,     9,    20,    21,    22,    23,    24,
       6,     7,    -1,    -1,    -1,    20,    21,    22,    23,    24,
       0,     1,    -1,     3,     4,     5,     6,     7,     8,     9,
       3,     4,     5,    20,    20,    -1,    -1,    -1,    25,    25,
      20,    21,    22,    23,    24,    -1,    -1,    20,    21,    22,
      23,    24,     1,    -1,    -1,    -1,    -1,     6,     7,     8,
       9,    17,    -1,    -1,    -1,    21,    22,    23,    24,    20,
      -1,    20,    -1,    -1,    25
};
...
{
       0,     3,     4,     5,    20,    21,    22,    23,    24,    27,
      28,    29,    30,    24,    31,    31,    31,    10,     0,    29,
       1,     6,     7,     8,     9,    20,    20,    25,    20,    20,
...
#line 84 "parser.y" /* yacc.c:1646  */
    { (yyval.node) = new AST::Data("inteiro", (yyvsp[0].inteiro)); }
#line 1330 "parser.tab.c" /* yacc.c:1646  */
    break;

  case 12:
#line 85 "parser.y" /* yacc.c:1646  */
    { (yyval.node) = AST::Data("real", (yyvsp[0].real));}
#line 1336 "parser.tab.c" /* yacc.c:1646  */
    break;

  case 13:
#line 86 "parser.y" /* yacc.c:1646  */
    { (yyval.node) = AST:Data("booleano", (yyvsp[0].booleano)); }
